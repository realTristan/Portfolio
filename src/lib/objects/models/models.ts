...
export const Textures = {
  GithubWallpaper: new THREE.TextureLoader().load(
    "./textures/github_wallpaper.jpg"
  ),
};

// Load the laptop model
export const LoadLaptopObject = async (Loader, Scene, Wallpaper) =>
  Loader.load("./laptop.glb", async (model) => {
    model = model.scene;
    model.traverse((obj) => {
