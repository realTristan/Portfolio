...
>
  <a href="https://github.com/realTristan" rel="noopener noreferrer" target="_blank" class="text-white text-4xl font-black tracking-widest">GITHUB</a>
  ...
  <div class="flex mt-6 mb-12 ml-4 flex-wrap w-[23rem] xl:w-[30rem] 2xl:w-[40rem]">
    <h2 class="text-gray-300 mb-10 mr-1 text-left text-xl leading-relaxed xl:text-2xl tracking-widest xl:leading-loose">
      My <a href="https://github.com/realTristan" rel="noopener noreferrer" target="_blank" class="text-[#38ffff] hover:underline duration-200">Github</a> 
      is home to over 30 projects, each built with various
