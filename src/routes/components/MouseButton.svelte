...
<a
  href="/#projects"
  class="hidden fixed xl:block bottom-14 opacity-60"
...
>
  <div class="{showMouse ? 'opacity-1' : 'opacity-0'} duration-700 ease-in-out">
    <div
      id="mouseScrollParent"
      class="rounded-full h-12 w-8 border-white border-2 cursor-pointer hover:opacity-30 ease-in-out duration-300"
    >
      <div id="mouseScrollChild" class="rounded-full bg-white h-2.5 w-1" />
    </div>
  </div>
</a>
